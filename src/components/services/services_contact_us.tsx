  ...
  return (
    <section>
      <div className="pt-44 pb-12 bg-gray-200 ">
        <div className="max-w-screen-2xl md:mx-auto mx-10 text-success pb-8 md:flex justify-center items-center gap-4">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg text-right lg:w-1/2 mt-10 md:mt0" data-aos="fade-right">
      ...
      <div className="bg-gray-100 pt-12 pb-32 bg-about3 bg-contain bg-no-repeat">
        <div className="max-w-screen-2xl md:mx-auto mx-10 mt-8" data-aos="fade-up">
