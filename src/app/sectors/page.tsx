    ...
    <section className="max-w-screen-3xl mx-auto bg-about3 bg-cover bg-no-repeat">
      <div className="bg-gray-200 pt-32 md:pt-44 pb-10 md:pb-20 px-4">
        <h1 className="text-success text-4xl md:text-5xl lg:text-6xl mt-4 text-center lg:max-w-screen-xl mx-auto leading-relaxed">
          قدرات MASA في خدمة القطاعات المختلفة كشريك ذهبي لـ Odoo
        </h1>
        <div className="max-w-screen-lg mx-auto text-center text-success text-2xl md:text-3xl lg:text-4xl pb-8">
          ...
          بصفتنا شريكًا ذهبيًا لـ Odoo، تمتلك MASA خبرة واسعة في تنفيذ الحلول الرقمية المتكاملة لمختلف القطاعات. نحن نساعد الشركات على تحقيق التحول الرقمي، وتحسين كفاءة العمليات، وزيادة الإنتاجية من خلال حلول Odoo المخصصة لكل صناعة.          </p>
        </div>
      </div>
