...
const partners = [
  { id: 1, src: "/partner/logo-1.png", alt: "شعار مايكروسوفت - شريك تقني", name: "Microsoft", description: "شركة رائدة في مجال التكنولوجيا تقدم حلولاً مبتكرة." },
  { id: 2, src: "/partner/Odoo-Logo.png", alt: "شعار أودو - شريك ذهبي", name: "Odoo", description: "مزود حلول ERP متكاملة لتحسين العمليات التجارية." },
  { id: 3, src: "/partner/Oracle-Cloud-Logo.png", alt: "شعار أوراكل كلاود - شريك سحابي", name: "Oracle", description: "شركة عالمية تقدم حلول سحابية متقدمة." },
];
      ...
      <div className="md:bg-about3 bg-cover bg-no-repeat">
        <div className="py-12 max-w-screen-xl mx-auto">
                ...
                <div className="text-success py-32 px-4 text-right transition-transform duration-300 hover:scale-105" key={item.id}>
                    <div className=" bg-white">
                      <div className="border border-success shadow-xl bg-white rounded-3xl flex justify-center items-center p-2 mt-2 h-44">
                        <Image src={item.src} alt={item.alt} height={100} width={300} />
                      </div>
                    </div>
                  </div>
              </SwiperSlide>
          ...
          <div className="custom-swiper-navigation flex justify-center">
              <button className="custom-swiper-button-prev rounded-lg text-success text-5xl" aria-label="الشريحة التالية">→</button>
              <button className="custom-swiper-button-next rounded-lg text-success text-5xl" aria-label="الشريحة السابقة">←</button>
          </div>
        </div>
      </div>
    </section>
