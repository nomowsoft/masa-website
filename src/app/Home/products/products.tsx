...
const Products = () => {
  ...
  return (
    <section className="bg-success">
      <div className="pt-44 lg:pb-10">
        <div className="text-center text-primary -mt-24">
        ...
        <div className="grid xl:grid-cols-3 md:grid-cols-3 grid-cols-2 gap-8 mx-20 py-20" data-aos="fade-up">
          <div className="text-center text-xl text-primary">
            <div className="flex justify-center">
              <Image src="/product/building.png" width={100} height={20} alt="..." />
            </div>
          ...
          <div className="text-center text-xl text-primary">
            <div className="flex justify-center">
              <Image src="/product/support.png" width={100} height={20} alt="..." />
            </div>
