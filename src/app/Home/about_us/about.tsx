    ...
    >
      <div className="container mx-auto grid lg:grid-cols-12 gap-8 px-4 lg:px-12">
        ...
        <div className="lg:col-span-6 place-self-center">
          ...
          <p
            data-aos="fade-down"
            className="max-w-4xl mt-6 text-gray-600 text-base md:text-lg lg:text-xl text-justify"
          >
            في ماسا، الابتكار ليس خيارًا، بل هو جزء من هويتنا. نحن نعمل على
            تطوير حلول تقنية متقدمة تتماشى مع احتياجات السوق وتوقعات عملائنا.
            من البرمجيات المصممة خصيصًا لدعم العمليات التجارية، إلى استراتيجيات
            التحول الرقمي التي تعيد تعريف طريقة عمل المؤسسات، نقدم حلولًا شاملة
            تعزز الإنتاجية، وتوفر تجربة سلسة للعملاء، وتضمن أداءً متفوقًا في
            بيئة أعمال تتسم بالتغير المستمر. كما أننا ندرك أهمية الأمان الرقمي
            في عالم مترابط، لذا نحرص على تقديم حلول متكاملة تحمي بيانات الشركات
            وتضمن بيئة تشغيل آمنة ومستقرة.
          </p>
        </div>
      </div>
    </section>
