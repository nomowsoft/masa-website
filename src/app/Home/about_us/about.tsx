...
const About = () => {
  return (
    <section
      id="about"
      className="py-4 lg:py-44 md:bg-about bg-no-repeat bg-right bg-cover mx-0 bg-gray-200"
    >
      <div className="container mx-auto grid lg:grid-cols-12 gap-8 px-4 lg:px-12">
        ...
        <div className="lg:col-span-6 place-self-center">
          <h1
            data-aos="fade-down"
            className="text-3xl md:text-4xl lg:text-5xl text-center text-success lg:text-start font-extrabold tracking-tight leading-tight mb-10"
          >
