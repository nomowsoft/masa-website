      ...
      <div className="pt-44 pb-12 bg-gray-200">
        <div className="max-w-screen-md md:mx-auto mx-10 text-success pb-8 text-center">
          <div data-aos="fade-down">
            <h1 className="text-success text-3xl lg:text-6xl mt-4 text-center">قصص النجاح</h1>
        ...
        <div className="max-w-screen-xl mx-auto">
          <div className="bg-white p-8 shadow-xl rounded-xl transition-transform duration-300 hover:scale-105 mb-12" data-aos="fade-up">
            <div className="flex flex-col lg:flex-row items-center gap-12">
              <div className="w-full lg:w-1/2">
                <iframe className={module.vedio} width="100%" height="315" src="https://www.youtube-nocookie.com/embed/YZ07nuEWl_8" title="قصة نجاح شركة المناهل القابضة" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" loading="lazy" />
              </div>
              <div className="text-gray-700 w-full lg:w-1/2">
                <h2 className="text-success text-4xl mb-4">شركة المناهل القابضة</h2>
          ...
          <div className="bg-white p-8 shadow-xl rounded-xl transition-transform duration-300 hover:scale-105 mb-12" data-aos="fade-up">
            <div className="flex flex-col lg:flex-row items-center gap-12">
              ...
              <div className="w-full lg:w-1/2">
                <iframe className={module.vedio} width="100%" height="315" src="https://www.youtube-nocookie.com/embed/YZ07nuEWl_8" title="قصة نجاح شركة المناهل القابضة - الجزء الثاني" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" loading="lazy" />
              </div>
            </div>
          </div>
          <div className="bg-white p-8 shadow-xl rounded-xl transition-transform duration-300 hover:scale-105 mb-12" data-aos="fade-up">
            <div className="flex flex-col lg:flex-row items-center gap-12">
              <div className="w-full lg:w-1/2">
                <iframe className={module.vedio} width="100%" height="315" src="https://www.youtube-nocookie.com/embed/YZ07nuEWl_8" title="قصة نجاح شركة المناهل القابضة - الجزء الثالث" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" loading="lazy" />
              </div>
              <div className="text-gray-700 w-full lg:w-1/2">
                <h2 className="text-success text-4xl mb-4">شركة المناهل القابضة</h2>
                <p className="text-gray-700 text-xl text-justify">
